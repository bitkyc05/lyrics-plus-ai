...
const SettingKeys = [
  ...
  "lyrics-plus:visual:phonetic-hyphen-replace",
  "lyrics-plus:visual:original-letter-spacing",
  "lyrics-plus:visual:phonetic-letter-spacing",
  "lyrics-plus:visual:translation-letter-spacing",
